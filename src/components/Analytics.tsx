    ...
    <div className="space-y-10">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2 font-sans text-lg">Comprehensive analysis of your crypto tax position</p>
        </div>
          ...
          <div key={metric.title} className="bg-white rounded-xl border border-gray-200 p-8 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-3 font-display">{metric.value}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-xl border border-gray-200 p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 font-display">Portfolio Breakdown</h2>
          ...
          {/* Tax Summary */}
          <div className="bg-white rounded-xl border border-gray-200 p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 font-display">Tax Summary</h2>
            <div className="space-y-6">
